...
from pages import face_detection, live_face_detection, photo_signing, photo_verification, \
        ...
        blink_detector, object_detection, pose_detection, hands_detection, foreground_segmentation, \
        text_recognition
...
app.add_page("Foreground Segmentation", foreground_segmentation.app)
...
app.add_page("Text Recognition", text_recognition.app)
